...
xmin:=0;
ymin:=0;
xmax:=Form2.Image1.Width;
ymax:=Form2.Image1.Height;
Form2.Image1.Canvas.Brush.Color:=clblack;
Form2.Image1.Canvas.FillRect(Rect(xmin,ymin,xmax,ymax));
...
For i:=1 to X do
   ...
   Form2.Image1.Canvas.MoveTo(starsx[i],starsy[i]);
   Form2.Image1.Canvas.LineTo(starsx[i],starsy[i]+1);
   end;
end;

procedure TForm2.MoveStars(Sender: TObject);
var
i:integer;
begin
For i:=1 to 800 do
   ...
   Form2.Image1.Canvas.MoveTo(starsx[i]+starsz[i],starsy[i]);
   Form2.Image1.Canvas.LineTo(starsx[i]+starsz[i],starsy[i]+2);
   If starsx[i]<=0 then
      begin
      starsx[i]:=1024;
      Form2.Image1.Canvas.Pen.Color:=clblack;
      Form2.Image1.Canvas.MoveTo(0,starsy[i]);
      Form2.Image1.Canvas.LineTo(0,starsy[i+1]);
      end;
   end;
end;
